...
WebUI.selectOptionByValue(findTestObject('Products_Sorting'), 'za', false)

List<WebElement> dataList = WebUI.findWebElements(findTestObject('Object Repository/Products_ProductList'), 0)
